...
const title = computed(() => t('components.error.403.title'))
...
<template>
  <div class="w-full h-screen flex items-center justify-center font-30">
    <UEmpty
      :title
      :description="$t('components.error.403.description')"
      size="lg"
      variant="naked"
      :actions="[
        {
          trailingIcon: 'i-lucide-arrow-right',
          label: i18nCommon('goHome'),
          onClick: goHome,
        },
      ]"
      :ui="{
    ...
    >
      <template #leading>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" width="80" height="80">
          <path
            fill="#EF9645"
